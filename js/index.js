$(document).ready(function(){
    ...
    $("#DesignT").click(function(){
        $("#Design").toggle();
        $("#DesignT").toggle();
    });
    $("#development").click(function(){
        $("#development").toggle();
        $("#developementT").toggle();
    });
    $("#developementT").click(function(){
        $("#development").toggle();
        $("#developementT").toggle();
    });
